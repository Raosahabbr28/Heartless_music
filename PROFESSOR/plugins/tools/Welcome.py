...
❖ ᴘᴏᴡᴇʀᴇᴅ  ➥ [𝐓ᴇᴀᴍ 𝐋ᴇɢᴇɴᴅ](https://t.me/ajisback)
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"✙ ᴋɪᴅɴᴀᴘ ᴍᴇ ✙", url=f"https://t.me/heartless_musicc_bot?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
